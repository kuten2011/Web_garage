          ...
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-2xl">
              ...
              <div className="space-y-8">
                <input placeholder="Tên phụ tùng" value={form.tenPT} onChange={e => setForm({ ...form, tenPT: e.target.value })} className="w-full px-6 py-5 border-2 border-gray-300 rounded-xl text-xl focus:ring-4 focus:ring-indigo-300" />
                <input type="number" placeholder="Đơn giá" value={form.donGia} onChange={e => setForm({ ...form, donGia: e.target.value })} className="w-full px-6 py-5 border-2 border-gray-300 rounded-xl text-xl focus:ring-4 focus:ring-purple-300" />
                <input type="number" placeholder="Số lượng tồn kho" value={form.soLuongTon} onChange={e => setForm({ ...form, soLuongTon: e.target.value })} className="w-full px-6 py-5 border-2 border-gray-300 rounded-xl text-xl focus:ring-4 focus:ring-green-300" />
              </div>
